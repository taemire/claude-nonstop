 ...
 *
 * Variants accepted:
 *   - limit phrase: "Limit reached", "You've hit your limit",
 *     "reached your (usage|rate) limit", "Rate limit (reached|hit)"
...
const RATE_LIMIT_PATTERN_LOOSE =
  /(?:Limit reached|You've hit your (?:usage |rate )?limit|reached your (?:usage |rate )?limit|Rate limit (?:reached|hit))\s*[·•—\-,:|]+\s*(?:resets?|resumes?|available again|try again)\s+(.+?)(?:\s*$|\n)/im;
