 ...
 * usage allocation; when they do, Claude Code surfaces one of:
 ...
 */
const ADMIN_DISABLE_PATTERN = /(?:Your usage allocation has been disabled by your admin|\/extra-usage to request more usage from your admin)/i;
...
function runOnce(claudeArgs, account, existingSessionId, options = {}) {
  return new Promise((resolve) => {
    ...
    child.onData((data) => {
      ...
      if (ADMIN_DISABLE_PATTERN.test(stripped)) {
